...
Class `TextComparison` has an entry point for comparing of two texts or two files:
	...
	java -cp txt-cmp-eval-26.3.3.jar;commons-lang3-3.20.0.jar org.javerland.txtcmpeval.TextComparison first.txt second.txt

	97 % (0.975)

Arguments which aren't paths to existing files are compared as texts:

	java -cp txt-cmp-eval-26.3.3.jar;commons-lang3-3.20.0.jar org.javerland.txtcmpeval.TextComparison "Dnes je pekny den" "Dnes je pkeny den"
